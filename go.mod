...
replace (
	github.com/longhorn/longhorn-engine => github.com/shuo-wu/longhorn-engine v0.4.1-0.20250307030433-3d243775f9a9
	github.com/longhorn/types => github.com/shuo-wu/types v0.0.0-20250306065916-e1b61d15b1a1
)
